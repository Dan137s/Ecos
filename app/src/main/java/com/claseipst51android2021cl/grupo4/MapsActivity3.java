...
//Añado el boton (+, -) del zoom en pantalla
        ...
        mMap.addMarker(new MarkerOptions().position(FMLS).draggable(true).title("Faro Monumental de La Serena").snippet("Lugar turístico se caracteriza por ser el símbolo de reconocimiento público de la ciudad es un faro funcional").icon(BitmapDescriptorFactory.fromResource(R.drawable.icoeco2)));
        ...
        mMap.addMarker(new MarkerOptions().position(PALS).draggable(true).title("Plaza de Armas La Serena").snippet("Plaza principal de la ciudad de La Serena se caracteriza por su masiva concurrencia entre las 11:00 y 18:00 hrs").icon(BitmapDescriptorFactory.fromResource(R.drawable.icoeco2)));
        ...
        mMap.addMarker(new MarkerOptions().position(ESPA).draggable(true).title("Espejo de Agua La Serena").snippet("Parque recreacional con aguas danzantes, un anfiteatro y un pueblo de artesanos").icon(BitmapDescriptorFactory.fromResource(R.drawable.icoeco2)));
        ...
        mMap.addMarker(new MarkerOptions().position(PAJP).draggable(true).title("Parque Japones La Serena").snippet("Un parque recreacional se caracteriza por tener un jardin estilo japon con fauna asiatica").icon(BitmapDescriptorFactory.fromResource(R.drawable.icoeco2)));
        ...
        mMap.addMarker(new MarkerOptions().position(PADV).draggable(true).title("Parque Pedro de Valdivia la serena").snippet("Parque recreacional se caracteriza por tener gran parte de fauna chilena y campestre #Condor, #Vicuñas, #Tortugas...").icon(BitmapDescriptorFactory.fromResource(R.drawable.icoeco2)));
        ...
        mMap.addMarker(new MarkerOptions().position(LRCV).draggable(true).title("La Recova La Serena").snippet("Parque recreacional se caracteriza por tener gran parte de fauna chilena #Condores, #Vicuñas, #Tortugas...").icon(BitmapDescriptorFactory.fromResource(R.drawable.icoeco2)));
        ...
        markerPrueba = googleMap.addMarker(new MarkerOptions()
                ...
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.icoeco2))
        );
